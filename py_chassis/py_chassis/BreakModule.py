        ...
        if ser.isOpen():
            try:
                ...
                motorCommand1 = "01100058001020\
                    ...
                    00000320\
                    00000001"
                motorCommandCrc1 = bytearray.fromhex(BreakModule().crc16Add(motorCommand1))

                motorCommand2 = "01100058001020\
                    00000000\
                    00000001\
                    0000157C\
                    00004E20\
                    ...
                    00000320\
                    00000001"
                motorCommandCrc2 = bytearray.fromhex(BreakModule().crc16Add(motorCommand2))
    ...
    def SetDistance(distance):
        ...
        if ser.isOpen():
            try:
                ...
                motorCommandTemp = "01100058001020\
                    00000001\
                    00000014\
                    0000xxxx\
                    000007D0\
                ...
                distanceString = f'{distance:x}'
                while len(distanceString)<4:
                    distanceString = "0" + distanceString
                print(distanceString)

                motorCommandRaw = motorCommandTemp.replace("xxxx", distanceString)

                motorCommandCrc = bytearray.fromhex(BreakModule().crc16Add(motorCommandRaw))                
    ...
    def Initialization():
        ...
        if ser.isOpen():
            try:
                ...
                motorCommandCrc_10000 = bytearray.fromhex(BreakModule().crc16Add(motorCommand_10000))
                motorCommandCrc_5000 = bytearray.fromhex(BreakModule().crc16Add(motorCommand_5000))
                motorCommandCrc_0 = bytearray.fromhex(BreakModule().crc16Add(motorCommand_0))
